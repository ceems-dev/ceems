...
test-e2e: $(PROMTOOL) build pkg/collector/testdata/sys/.unpacked pkg/collector/testdata/proc/.unpacked
	...
	./scripts/e2e-test.sh -s cacct-admin-user-all-users-account-filter
...
test-e2e: $(PROMTOOL) build pkg/collector/testdata/sys/.unpacked pkg/collector/testdata/proc/.unpacked
	...
	./scripts/e2e-test.sh -s api-units-query-lsf
	...
	./scripts/e2e-test.sh -s api-current-usage-query-lsf
	...
	./scripts/e2e-test.sh -s api-global-usage-query-lsf
...
test-e2e-update: build pkg/collector/testdata/sys/.unpacked pkg/collector/testdata/proc/.unpacked
	...
	./scripts/e2e-test.sh -s cacct-admin-user-all-users-account-filter -u || true
...
test-e2e-update: $(PROMTOOL) build pkg/collector/testdata/sys/.unpacked pkg/collector/testdata/proc/.unpacked
	...
	./scripts/e2e-test.sh -s api-user-query-lsf -u || true
	...
	./scripts/e2e-test.sh -s api-units-query-lsf -u || true
	...
	./scripts/e2e-test.sh -s api-current-usage-query-lsf -u || true
	...
	./scripts/e2e-test.sh -s api-global-usage-query-lsf -u || true
