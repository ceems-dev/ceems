...
func bpfVFSObjs(kernelVersion int64) string {
	...
	if kernelVersion > KernelStringToNumeric("6.18") {
		return "bpf_vfs.o"
	} else if kernelVersion > KernelStringToNumeric("6.14") && kernelVersion <= KernelStringToNumeric("6.18") {
		return "bpf_vfs_v618.o"
