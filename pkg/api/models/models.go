...
type Unit struct {
	...
	TotalCustomStats    MetricMap  `example:"instr_total:454342323,cycles_total:23232323"                                                 json:"total_custom_stats,omitempty"         sql:"total_custom_stats"                  sqlitetype:"text"    swaggertype:"object,number"` // Total statistics of misc custom metrics of unit. These metrics can be anything where total value is relevant
	AveCustomStats      MetricMap  `example:"mem_bw_avg:2545"                                                                             json:"avg_custom_stats,omitempty"           sql:"avg_custom_stats"                    sqlitetype:"text"    swaggertype:"object,number"` // Average statistics of misc custom metrics of unit. These metrics can be anything where average value is relevant
	MinCustomStats      MetricMap  `example:"host_pwr_min:36"                                                                             json:"min_custom_stats,omitempty"           sql:"min_custom_stats"                    sqlitetype:"text"    swaggertype:"object,number"` // Minimum statistics of misc custom metrics of unit. These metrics can be anything where minimum value is relevant
	MaxCustomStats      MetricMap  `example:"gpu_power_max:454"                                                                           json:"max_custom_stats,omitempty"           sql:"max_custom_stats"                    sqlitetype:"text"    swaggertype:"object,number"` // Maximum statistics of misc custom metrics of unit. These metrics can be anything where maxoimum value is relevant
...
type Usage struct {
	...
	TotalIOWriteStats   MetricMap `example:"bytes_total:12000000,requests_total:13923"                                                   json:"total_io_write_stats,omitempty"       sql:"total_io_write_stats"                sqlitetype:"text"    swaggertype:"object,number"` // Total IO write statistics during lifetime of project
	TotalIOReadStats    MetricMap `example:"bytes_total:245000000,requests_total:49423"                                                  json:"total_io_read_stats,omitempty"        sql:"total_io_read_stats"                 sqlitetype:"text"    swaggertype:"object,number"` // Total IO read statistics during lifetime of project
	TotalIngressStats   MetricMap `example:"bytes_total:8503405,packets_total:43423"                                                     json:"total_ingress_stats,omitempty"        sql:"total_ingress_stats"                 sqlitetype:"text"    swaggertype:"object,number"` // Total Ingress statistics of project
	TotalEgressStats    MetricMap `example:"bytes_total:454342323,packets_total:23232323"                                                json:"total_egress_stats,omitempty"         sql:"total_egress_stats"                  sqlitetype:"text"    swaggertype:"object,number"` // Total Egress statistics of project
	TotalCustomStats    MetricMap `example:"instr_total:454342323,cycles_total:23232323"                                                 json:"total_custom_stats,omitempty"         sql:"total_custom_stats"                  sqlitetype:"text"    swaggertype:"object,number"` // Total statistics of misc custom metrics during lifetime of project. These metrics can be anything where total value is relevant
	AveCustomStats      MetricMap `example:"mem_bw_avg:2545"                                                                             json:"avg_custom_stats,omitempty"           sql:"avg_custom_stats"                    sqlitetype:"text"    swaggertype:"object,number"` // Average statistics of misc custom metrics during lifetime of project. These metrics can be anything where average value is relevant
	MinCustomStats      MetricMap `example:"host_pwr_min:36"                                                                             json:"min_custom_stats,omitempty"           sql:"min_custom_stats"                    sqlitetype:"text"    swaggertype:"object,number"` // Minimum statistics of misc custom metrics during lifetime of project. These metrics can be anything where minimum value is relevant
	MaxCustomStats      MetricMap `example:"gpu_power_max:454"                                                                           json:"max_custom_stats,omitempty"           sql:"max_custom_stats"                    sqlitetype:"text"    swaggertype:"object,number"` // Maximum statistics of misc custom metrics during lifetime of project. These metrics can be anything where maxoimum value is relevant
