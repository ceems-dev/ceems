        ...
        "schemas": {
            "http.Response-any": {
                "properties": {
                    ...
                    "errorType": {
                        "$ref": "#/components/schemas/http.errorType"
                    },
                    "status": {
                        "type": "string"
                    },
            ...
            "http.Response-models_Stat": {
                "properties": {
                    "data": {
                        "items": {
                            "$ref": "#/components/schemas/models.Stat"
                        },
                        "type": "array",
                        "uniqueItems": false,
                        "x-nullable": true,
            ...
            "http.Response-models_Unit": {
                "properties": {
                    "data": {
                        "items": {
                            "$ref": "#/components/schemas/models.Unit"
                        },
                        "type": "array",
                        "uniqueItems": false,
                        "x-nullable": true,
            ...
            "http.Response-models_Usage": {
                "properties": {
                    "data": {
                        "items": {
                            "$ref": "#/components/schemas/models.Usage"
                        },
                        "type": "array",
                        "uniqueItems": false,
                        "x-nullable": true,
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/http.Response-models_Cluster"
                                }
                            }
                        },
                        "description": "OK"
                    ...
                    "403": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/http.Response-any"
                                }
                            }
                        },
                        ...
                        "content": {
                            "application/json": {
                                "schema": {
                                    "oneOf": [
                                        {
                                            "$ref": "#/components/schemas/http.Response-models_Unit"
                                        },
                                        {
                                            "$ref": "#/components/schemas/http.Response-models_Usage"
                                        }
                                    ]
                                }
                            }
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/http.Response-models_Project"
                                }
                            }
                        },
                        "description": "OK"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/http.Response-models_Stat"
                                }
                            }
                        },
                        "description": "OK"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/http.Response-models_User"
                                }
                            }
                        },
                        "description": "OK"
